...
bool DoublyLinkedBag<ItemType>::add(const ItemType& newEntry)
{
  ...
  DoubleNode<ItemType>* nextNodePtr = new DoubleNode<ItemType>();
...
{
  DoubleNode<ItemType>* entryNodePtr = getPointerTo(anEntry);
...
template<class ItemType>
DoubleNode<ItemType>* DoublyLinkedBag<ItemType>::getPointerTo(const ItemType& anEntry) const
{
  bool found = false;
  DoubleNode<ItemType>* curPtr = headPtr;
